...
draft: false
summary: 'Greedy & Dynamic Programming 는 정확히 말하자면 특정 알고리즘이라고 보기 보다는 문제 풀이 방식으로 이해하는 것이 좀 더 정확하다. Greedy & Dynamic Programming 를 이용해서 어떠한 방식으로 문제에 접근 하고 해결하는지 알아보자.'
images: ['/static/images/canada/mountains.jpg', '/static/images/canada/toronto.jpg']
authors: ['default']
---

![main](/static/greedy-dp/cover.jpg)
...
![greedy](/static/greedy-dp/greedy.png)
