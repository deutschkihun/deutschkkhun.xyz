...
## 프롤로그: Time complexity 와 Space complexity 를 알아야 하는 이유

- Time comlexity: measure of the efficiency of an algorithm. Understand the performance of the algorithm, Optimize the algorithm
-
