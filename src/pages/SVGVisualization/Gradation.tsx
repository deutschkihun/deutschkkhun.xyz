...
const Gradation = (): JSX.Element => {
  return (
    <Box>
      <Subtitle>SVG basic: gradation</Subtitle>
      <Paragraph>
        For gradation in svg, please use stop tag and gradient tag. First one has no
        gradataion, second one has linear gradient effect, last one has radial gradient
        effect
      </Paragraph>
